...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'build/web/server.data';
      var REMOTE_PACKAGE_BASE = 'server.data';
...
Module['FS_createPath']("/assets", "map", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/web/server.data');

      };
      Module['addRunDependency']('datafile_build/web/server.data');
...
var ASM_CONSTS = {
  ...
  function _net_accept()
  {
    return Module.net_accept();
  }

  function _net_listen()
  {
    console.log("net_listen(): unimplemented");
  }

  function _net_sock_read(sock_id, payload_ptr, max)
  {
