...
EM_CFLAGS=-s WASM=1 -O3 -s -s --js-library html/cl-library.js --post-js html/cl-main.js --pre-js html/net.js
EM_LDFLAGS=-s USE_SDL=2 -s USE_SDL_IMAGE=2 -s USE_WEBGL2=1
EM_SRC=$(SRC_DIR)/client/*.c $(SRC_DIR)/game/*.c $(SRC_DIR)/common/*.c $(SRC_DIR)/renderer/*.c
